...
const translations = {
    fr: {
        ...
        <p class="text-neutral-400 text-sm"><span class="text-3xl">🚴‍♂️</span> Si je peux y aller à vélo, alors j'y vais à vélo, le sport est une partie essentielle de ma vie et me permet de rester en forme mentale et physique.</p>`
